...
int main(int argc, char *argv[]) {
  ...
  while (!quit) {
    ...
    gBMP = SDL_CreateRGBSurfaceFrom((void *)output, 512, 512, 32, 4 * 512, 0, 0,
                                    0, 0);
...
void calculate_new_frame() {
  ...
  cube.position_vector[0] =
      cube.position_vector[0] + pos_speed * (key_table[3] - key_table[1]);
  cube.position_vector[1] =
      cube.position_vector[1] + pos_speed * (key_table[0] - key_table[2]);
  cube.position_vector[2] =
      cube.position_vector[2] + pos_speed * (key_table[10] - key_table[8]);
  cube.rotation_vector[0] =
      cube.rotation_vector[0] + rot_speed * (key_table[4] - key_table[6]);
  cube.rotation_vector[1] =
      cube.rotation_vector[1] + rot_speed * (key_table[5] - key_table[7]);
  cube.rotation_vector[2] =
      cube.rotation_vector[2] + rot_speed * (key_table[11] - key_table[9]);
}
